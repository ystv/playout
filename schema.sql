...
-- * yusu (done by appointed person or bot) Mostly bar football, but also 
-- * university (done by appointed person or bot) mostly university signage
--
...
CREATE TABLE playout.programmes(
    ...
    idents_id int NOT NULL REFERENCES playout.ident_groups(group_id),
    video_urls
);
...
CREATE TABLE playout.programme_videos (
    ...
    programme_id int NOT NULL REFERENCES playout.programmes(programe_id),
    in_time int NOT NULL DEFAULT 0,
    out_time int NOT NULL DEFAULT 0,
    duration int NOT NULL DEFAULT 0,
    source text NOT NULL
);

COMMENT ON playout.programme_videos(out_time) IS 'If 0, it will play for the entire video duration, if higher it will loop';
COMMENT ON playout.programme_videos(duration) IS 'If 0, it will play for entire video duration, if higher it will loop';